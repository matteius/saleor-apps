...
export type OrderLineDetailsFragment = { id: string, productName: string, variantName: string, productSku?: string | null, quantity: number, unitPrice: { gross: { amount: number, currency: string } }, totalPrice: { gross: { amount: number, currency: string } } };

export type OrderDetailsFragment = { id: string, number: string, userEmail?: string | null, channel: { id: string, slug: string }, user?: { id: string, email: string } | null, lines: Array<{ id: string, productName: string, variantName: string, productSku?: string | null, quantity: number, unitPrice: { gross: { amount: number, currency: string } }, totalPrice: { gross: { amount: number, currency: string } } }>, total: { gross: { amount: number, currency: string } } };
