...
export type SubscriptionCustomerCreateMutationVariables = Exact<{
  input: UserCreateInput;
}>;


export type SubscriptionCustomerCreateMutation = { readonly customerCreate?: { readonly user?: { readonly id: string, readonly email: string } | null, readonly errors: ReadonlyArray<{ readonly field?: string | null, readonly message?: string | null, readonly code: AccountErrorCode }> } | null };
...
export type SubscriptionOrderVoidMutationVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type SubscriptionOrderVoidMutation = { readonly orderVoid?: { readonly order?: { readonly id: string } | null, readonly errors: ReadonlyArray<{ readonly field?: string | null, readonly message?: string | null, readonly code: OrderErrorCode }> } | null };
...
export type SubscriptionFindCustomerByEmailQueryVariables = Exact<{
  email: Scalars['String']['input'];
}>;


export type SubscriptionFindCustomerByEmailQuery = { readonly customers?: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly email: string } }> } | null };
...
export const UntypedTransactionRefundRequestedEventFragmentDoc = gql`
  ...
  transaction {
    ...
    `;
export const UntypedSubscriptionCustomerCreateDocument = gql`
    mutation SubscriptionCustomerCreate($input: UserCreateInput!) {
...
export const UntypedSubscriptionDraftOrderCreateDocument = gql`
  ...
  draftOrderCreate(input: $input) {
    ...
    `;
export const UntypedSubscriptionOrderVoidDocument = gql`
    mutation SubscriptionOrderVoid($id: ID!) {
  orderVoid(id: $id) {
    order {
      id
    }
...
export const UntypedSubscriptionFindCustomerByEmailDocument = gql`
    query SubscriptionFindCustomerByEmail($email: String!) {
...
export const SubscriptionCustomerCreateDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SubscriptionCustomerCreate"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UserCreateInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"customerCreate"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"email"}}]}},{"kind":"Field","name":{"kind":"Name","value":"errors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"field"}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"code"}}]}}]}}]}}]} as unknown as DocumentNode<SubscriptionCustomerCreateMutation, SubscriptionCustomerCreateMutationVariables>;
...
export const SubscriptionOrderVoidDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SubscriptionOrderVoid"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"orderVoid"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"order"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"Field","name":{"kind":"Name","value":"errors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"field"}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"code"}}]}}]}}]}}]} as unknown as DocumentNode<SubscriptionOrderVoidMutation, SubscriptionOrderVoidMutationVariables>;
...
export const SubscriptionFindCustomerByEmailDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SubscriptionFindCustomerByEmail"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"email"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"customers"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"filter"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"search"},"value":{"kind":"Variable","name":{"kind":"Name","value":"email"}}}]}},{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"IntValue","value":"1"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"edges"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"node"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"email"}}]}}]}}]}}]}}]} as unknown as DocumentNode<SubscriptionFindCustomerByEmailQuery, SubscriptionFindCustomerByEmailQueryVariables>;
