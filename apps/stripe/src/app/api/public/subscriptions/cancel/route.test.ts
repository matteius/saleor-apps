 ...
 *
 * HTTP integration test for POST /api/public/subscriptions/cancel (T19a).
 */
...
import * as cancelHandlers from "./route";
...
describe("POST /api/public/subscriptions/cancel", () => {
  it("bubbles up 501 NOT_IMPLEMENTED from the internal stub", async () => {
    const body = JSON.stringify({ stripeSubscriptionId: "sub_test_1" });
