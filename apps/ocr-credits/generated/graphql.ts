...
export type OrderFullyPaidSubscription = { event?: { order?: { id: string, number: string, userEmail?: string | null, channel: { id: string, slug: string }, user?: { id: string, email: string } | null, lines: Array<{ id: string, productName: string, variantName: string, productSku?: string | null, quantity: number, quantityFulfilled: number, quantityToFulfill: number, variant?: { id: string } | null, unitPrice: { gross: { amount: number, currency: string } }, totalPrice: { gross: { amount: number, currency: string } } }>, total: { gross: { amount: number, currency: string } } } | null } | {} | null };
